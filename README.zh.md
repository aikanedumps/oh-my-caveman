...
[快速开始](#快速开始) • [文档](https://yeachan-heo.github.io/oh-my-caveman-website) • [CLI 参考](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference) • [工作流](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows) • [迁移指南](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **注意：包命名** — 项目品牌名为 **oh-my-caveman**（仓库、插件、命令），但 npm 包以 [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman) 发布。通过 npm/bun 安装 CLI 工具时，请使用 `npm install -g oh-my-caveman`。
...
### 执行模式
针对不同场景的多种策略 - 从全自动构建到 token 高效重构。[了解更多 →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
- **[CLI 参考](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference)** - 所有 `omc` 命令、标志和工具
- **[通知指南](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#notifications)** - Discord、Telegram、Slack 和 webhook 设置
- **[推荐工作流](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows)** - 常见任务的经过实战检验的技能链
- **[发布说明](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#release-notes)** - 每个版本的新内容
- **[网站](https://yeachan-heo.github.io/oh-my-caveman-website)** - 交互式指南和示例
