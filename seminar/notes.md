# Speaker Notes: oh-my-caveman Seminar
...
**The Reveal**
- "That's exactly what oh-my-caveman does. It transforms Claude Code from a single generalist assistant into a coordinated team of 28 specialists."
...
- "Installation: `/oh-my-caveman:hud setup` - adds to your shell prompt"
...
claude-code "/oh-my-caveman:omc-setup"
...
Then invoke: `Task(subagent_type="oh-my-caveman:pytest-specialist")`
