# oh-my-caveman Quick Reference Card
**v3.6.3 | github.com/aikanedumps/oh-my-caveman**
...
| Command | Purpose |
|---------|---------|
| `/oh-my-caveman:omc-setup` | Initial setup wizard |
| `/oh-my-caveman:hud setup` | Enable HUD statusline |
| `/oh-my-caveman:omc-doctor` | Diagnose issues |
| `/oh-my-caveman:omc-help` | Show usage guide |
| `/oh-my-caveman:cancel` | Stop current operation |
| `/oh-my-caveman:note` | Save compaction-resilient note |
| `/oh-my-caveman:learner` | Extract reusable skill |
| `/oh-my-caveman:analyze` | Deep analysis/debugging |
| `/oh-my-caveman:deepsearch` | Thorough codebase search |
| `/oh-my-caveman:ultraqa` | QA cycling (test/fix/repeat) |
| `/oh-my-caveman:tdd` | Test-driven development mode |
...
## Resources
- **GitHub:** github.com/aikanedumps/oh-my-caveman
- **Docs:** /docs/REFERENCE.md
- **Website:** yeachan-heo.github.io/oh-my-caveman-website
- **NPM:** `npm i -g oh-my-caveman`
