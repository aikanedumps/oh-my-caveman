...
---
# oh-my-caveman: Multi-Agent Orchestration for Claude Code
...
Note: This is a 60-minute seminar covering the complete oh-my-caveman system. We'll focus on practical usage patterns.
...
/oh-my-caveman:autopilot Add OAuth2 authentication
...
```javascript
Task(
  subagent_type="oh-my-caveman:executor-low",
  model="haiku",
...
**Method 2: NPM Global**
```bash
npm install -g oh-my-caveman
```

**Method 3: Manual Git Clone**
```bash
git clone https://github.com/aikanedumps/oh-my-caveman.git
cd oh-my-caveman
...
**GitHub Repository**
```
github.com/aikanedumps/oh-my-caveman
```

**Website & Documentation**
```
yeachan-heo.github.io/oh-my-caveman-website
```
...
**Getting Help**
```
/oh-my-caveman:omc-help    - Usage guide
/oh-my-caveman:omc-doctor  - Diagnose issues
```
...
| How do I stop a runaway autopilot? | Say "stop", "cancel", or `/oh-my-caveman:cancel` |
| Why is my HUD not showing? | Run `/oh-my-caveman:hud setup` |
...
|----------|--------------|--------|
| `autopilot:` | `/oh-my-caveman:autopilot` | Full autonomous mode |
| `ralph:` | `/oh-my-caveman:ralph` | Persistence mode |
| `ulw` | `/oh-my-caveman:ultrawork` | Parallel execution |
| `eco:` | `/oh-my-caveman:` | Token-efficient mode |
| `plan` | `/oh-my-caveman:plan` | Planning interview |
