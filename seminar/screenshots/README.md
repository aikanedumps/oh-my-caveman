...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ claude @ oh-my-caveman                                    [Phase 4/5] ⚡ │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
**Capture Instructions:**
1. Ensure HUD is installed: `claude` then `/oh-my-caveman:hud setup`
...
1. Use a pipeline preset or custom pipeline:
   ```
   /oh-my-caveman:pipeline review "analyze the authentication system"
   ```
...
1. Start swarm mode:
   ```
   /oh-my-caveman:swarm 5:executor "implement all CRUD operations"
   ```
