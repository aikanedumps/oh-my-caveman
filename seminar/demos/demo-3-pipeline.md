...
```
/oh-my-caveman:pipeline review
```

Or demonstrate custom pipeline:
```
/oh-my-caveman:pipeline explore:haiku -> architect:opus -> critic:opus -> executor:sonnet
```
...
```
/oh-my-caveman:pipeline explore:haiku -> architect:opus -> executor-high:opus -> qa-tester:sonnet
```
...
```
/oh-my-caveman:pipeline research
```
