...
### Required Setup
- OMC installed and configured (`/oh-my-caveman:omc-setup` completed)
- HUD statusline installed (`/oh-my-caveman:hud setup`)
...
which omc || echo "Run: /oh-my-caveman:omc-setup"
...
- [ ] No active OMC operations running (`/oh-my-caveman:cancel --all`)
...
### Closing (1 min)
"OMC transforms how you work with Claude - from manual coding to orchestrating specialized agents. All open source at github.com/aikanedumps/oh-my-caveman."
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-caveman:cancel`
...
**Solution**: Jump to next phase or use `/oh-my-caveman:cancel` and show fallback
