...
This document describes the security configuration and deployment guidelines for oh-my-caveman (OMC).
...
- Install OMC manually (`oh-my-caveman install`), not via agent
...
If you discover a security vulnerability, please report it via [GitHub Issues](https://github.com/aikanedumps/oh-my-caveman/issues) with the `security` label.
