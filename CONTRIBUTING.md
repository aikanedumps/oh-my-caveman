# Contributing to oh-my-caveman

Thank you for your interest in contributing to oh-my-caveman (OMC). This guide covers everything from forking to submitting your PR.
...
1. **Fork the repository** on GitHub by clicking the "Fork" button at https://github.com/aikanedumps/oh-my-caveman

2. **Clone your fork**:
   ```bash
   git clone https://github.com/<your-username>/oh-my-caveman.git
   cd oh-my-caveman
   ```

3. **Add the upstream remote** so you can sync with the main repository:
   ```bash
   git remote add upstream https://github.com/aikanedumps/oh-my-caveman.git
   ```

4. **Verify your remotes**:
   ```bash
   git remote -v
   # origin    https://github.com/<your-username>/oh-my-caveman.git (fetch)
   # origin    https://github.com/<your-username>/oh-my-caveman.git (push)
   # upstream  https://github.com/aikanedumps/oh-my-caveman.git (fetch)
   # upstream  https://github.com/aikanedumps/oh-my-caveman.git (read-only)
   ```
...
All three flows below use the `omc` CLI. If you don't have it installed globally (via `npm i -g oh-my-caveman`), create a symlink from your checkout:
...
claude plugin marketplace add /path/to/oh-my-caveman

# Install the plugin
claude plugin install oh-my-caveman@oh-my-caveman
...
```bash
npm run build
claude plugin marketplace update oh-my-caveman
claude plugin update oh-my-caveman@oh-my-caveman
/setup
```
...
export OMC_DEV_ROOT="$HOME/_Git/_Claude/oh-my-caveman"
...
2. **Open a PR** on GitHub:
   - Go to https://github.com/aikanedumps/oh-my-caveman/pulls
...
4. **Release workflow** (advanced):
   - If your PR should trigger a release, you can invoke the `/oh-my-caveman:release` skill
...
```bash
omc --plugin-dir /path/to/oh-my-caveman
```
...
- **GitHub Issues**: https://github.com/aikanedumps/oh-my-caveman/issues
