...
describe('pre-tool-enforcer fallback gating (issue #970)', () => {
  ...
  it('preserves Agent spawn warnings for real subagent delegation', () => {
    ...
    const hookSpecificOutput = output.hookSpecificOutput as Record<string, unknown>;
    expect(output.continue).toBe(true);
    expect(String(hookSpecificOutput.additionalContext)).toContain('Spawning agent: oh-my-caveman:executor');
  });
  ...
  it('allows tier alias "sonnet" through when OMC_SUBAGENT_MODEL is set and forceInherit is enabled', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:architect', model: 'sonnet' },
        cwd: tempDir,
  ...
  it('allows tier alias "opus" via ANTHROPIC_DEFAULT_OPUS_MODEL without OMC_SUBAGENT_MODEL', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:architect', model: 'opus' },
        cwd: tempDir,
  ...
  it('allows tier alias "haiku" via ANTHROPIC_DEFAULT_HAIKU_MODEL without OMC_SUBAGENT_MODEL', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:executor', model: 'haiku' },
        cwd: tempDir,
  ...
  it.each([
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:executor', model: tier },
        cwd: tempDir,
        session_id: sessionId,
      },
      {
  ...
  it('blocks tier alias when proxy ANTHROPIC_DEFAULT_*_MODEL is only whitespace', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:executor', model: 'sonnet' },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:critic',
  ...
  it('blocks tier alias when OMC_SUBAGENT_MODEL has a [1m] extended-context suffix', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:executor', model: 'opus' },
        cwd: tempDir,
  ...
  it('still blocks bare Anthropic model ID even when OMC_SUBAGENT_MODEL is set', () => {
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: { subagent_type: 'oh-my-caveman:executor', model: 'claude-sonnet-4-6' },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:../docs/CLAUDE',
          description: 'Some task',
          prompt: 'Do something',
        },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:body-hr-agent',
          description: 'Some task',
          prompt: 'Do something',
        },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:body-model-agent',
          description: 'Some task',
          prompt: 'Do something',
        },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:quoted-model-agent',
          description: 'Review spec',
          prompt: 'Review this spec',
        },
        cwd: tempDir,
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:bedrock-quoted-agent',
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:bom-agent',
    ...
    const output = runPreToolEnforcerWithEnv(
      {
        tool_name: 'Agent',
        toolInput: {
          subagent_type: 'oh-my-caveman:nonexistent-agent-xyz',
          description: 'Some task',
          prompt: 'Do something',
        },
        cwd: tempDir,
