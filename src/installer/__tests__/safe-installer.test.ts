...
describe('isOmcHook', () => {
  ...
  it('returns true for commands containing "oh-my-caveman"', () => {
    expect(isOmcHook('node ~/.claude/hooks/oh-my-caveman-hook.mjs')).toBe(true);
    expect(isOmcHook('bash $HOME/.claude/hooks/oh-my-caveman.sh')).toBe(true);
  });

  it('returns false for commands not containing omc or oh-my-caveman', () => {
