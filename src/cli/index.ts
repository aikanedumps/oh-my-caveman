...
Examples:
  ...
  .action(async () => {
    ...
    console.log(chalk.blue.bold('\noh-my-caveman System Information\n'));
...
Examples:
  ...
  .action(async (options) => {
    if (!options.quiet) {
      console.log(chalk.blue('oh-my-caveman Update\n'));
    }
...
Examples:
  ...
  .action(async () => {
    ...
    console.log(chalk.blue.bold('\noh-my-caveman Version Information\n'));
    console.log(chalk.gray('━'.repeat(50)));
    ...
    console.log(chalk.gray('\n━'.repeat(50)));
    console.log(chalk.gray('\nTo check for updates, run: oh-my-caveman update --check'));
  });
...
Examples:
  ...
  .action(async (options) => {
    if (!options.quiet) {
      console.log(chalk.blue('╔═══════════════════════════════════════════════════════════╗'));
      console.log(chalk.blue('║         oh-my-caveman Installer                        ║'));
...
Examples:
  ...
  .action(async (options) => {
    if (!options.quiet) {
      console.log(chalk.blue('oh-my-caveman Setup\n'));
    }
    ...
    if (!options.quiet) {
      ...
      console.log(chalk.gray('Start Claude Code and use /oh-my-caveman:omc-setup for interactive setup.'));
    }
  });
...
program
  ...
  .action(async () => {
    ...
    if (result.success) {
      console.log(chalk.green('✓ oh-my-caveman installed successfully!'));
      console.log(chalk.gray('  Run "oh-my-caveman info" to see available agents.'));
      ...
      console.warn(chalk.gray('  Run "oh-my-caveman install" manually to complete setup.'));
    }
  });
