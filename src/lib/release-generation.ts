...
const DEFAULT_REPO_URL = 'https://github.com/aikanedumps/oh-my-caveman';
...
export function generateChangelog(
  ...
  let md = `# oh-my-caveman v${version}: ${title}\n\n`;
  md += `## Release Notes\n\n${summary}\n`;
...
export function generateReleaseBody(
  ...
  body += `\n### Install / Update\n\n`;
  body += '```bash\n';
  body += `npm install -g oh-my-caveman@${version}\n`;
  body += '```\n\n';
  body += 'Or reinstall the plugin:\n```bash\nclaude /install-plugin oh-my-caveman\n```\n';
