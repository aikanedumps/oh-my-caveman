...
describe('AutopilotValidation', () => {
  ...
  describe('getValidationSpawnPrompt', () => {
    it('should return prompt with spec path', () => {
      ...
      expect(prompt).toContain('oh-my-caveman:architect');
      expect(prompt).toContain('oh-my-caveman:security-reviewer');
      expect(prompt).toContain('oh-my-caveman:code-reviewer');
    });
