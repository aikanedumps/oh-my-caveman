...
\`\`\`
Task(
  subagent_type="oh-my-caveman:analyst",
  model="opus",
...
\`\`\`
Task(
  subagent_type="oh-my-caveman:architect",
  model="opus",
...
Task(subagent_type="oh-my-caveman:executor-low", model="haiku", prompt="...")

// For standard implementation (feature, multiple methods)
Task(subagent_type="oh-my-caveman:executor", model="sonnet", prompt="...")

// For complex work (architecture, debugging, refactoring)
Task(subagent_type="oh-my-caveman:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="oh-my-caveman:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="oh-my-caveman:debugger",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="oh-my-caveman:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="oh-my-caveman:code-reviewer",
  model="opus",
