...
Would you like me to extract this as a learned skill? Type \`/oh-my-caveman:skillify\` to save it (\`/oh-my-caveman:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
