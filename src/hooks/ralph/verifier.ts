 ...
 * 4. If architect approves -> truly complete, use /oh-my-caveman:cancel to exit
...
3. **Based on ${criticLabel}'s response:**
   - If APPROVED: Output the exact correlated approval tag \`${approvalTag}\`, then run \`/oh-my-caveman:cancel\` to cleanly exit
...
4. After ${criticLabel} approves, run \`/oh-my-caveman:cancel\` to cleanly exit
