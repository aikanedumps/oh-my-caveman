...
export interface ExplicitWorkflowSlashInvocation {
  /** Canonical workflow skill name (lowercase, no `oh-my-caveman:` prefix). */
 ...
 *
 * Recognizes `/<skill>`, `/omc:<skill>`, and `/oh-my-caveman:<skill>` for
...
export function detectKeywordsWithType(
  ...
  // `/oh-my-caveman:`), and code-fence/backtick wrapping (handled inside
