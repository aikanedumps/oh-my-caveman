...
function selectAgentType(component: Component): string {
  const roleToAgent: Record<ComponentRole, string> = {
    frontend: 'oh-my-caveman:designer',
    backend: 'oh-my-caveman:executor',
    database: 'oh-my-caveman:executor',
    api: 'oh-my-caveman:executor',
    ui: 'oh-my-caveman:designer',
    shared: 'oh-my-caveman:executor',
    testing: 'oh-my-caveman:qa-tester',
    docs: 'oh-my-caveman:writer',
    config: 'oh-my-caveman:executor',
    module: 'oh-my-caveman:executor'
  };

  return roleToAgent[component.role] || 'oh-my-caveman:executor';
}
