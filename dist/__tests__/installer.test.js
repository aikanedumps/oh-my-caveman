    ...
    describe('No self-referential deprecation stubs (#582)', () => {
        it('should not have any commands/*.md files that redirect to their own skill name', () => {
            ...
            for (const file of files) {
                ...
                const skillInvokePattern = new RegExp(`/oh-my-caveman:${commandName.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}`, 'i');
...
# oh-my-caveman - Intelligent Multi-Agent Orchestration`;
        ...
        it('falls back to legacy heading versions', () => {
            const content = '# oh-my-caveman v4.6.0 - Intelligent Multi-Agent Orchestration';
    ...
    describe('Plugin Detection', () => {
        ...
        it('should return true when CLAUDE_PLUGIN_ROOT is set', () => {
            process.env.CLAUDE_PLUGIN_ROOT = '/home/user/.claude/plugins/marketplaces/oh-my-caveman';
    ...
    describe('Project-Scoped Plugin Detection', () => {
        ...
        it('should return false for global plugin installation', () => {
            ...
            process.env.CLAUDE_PLUGIN_ROOT = join(CLAUDE_CONFIG_DIR, 'plugins', 'cache', 'omc', 'oh-my-caveman', '3.9.0');
            expect(isProjectScopedPlugin()).toBe(false);
        });
        it('should return true for project-scoped plugin installation', () => {
            ...
            process.env.CLAUDE_PLUGIN_ROOT = '/home/user/myproject/.claude/plugins/oh-my-caveman';
