...
describe('Builtin Skills', () => {
    ...
    describe('createBuiltinSkills()', () => {
        it('should return correct number of skills (41 canonical + 2 aliases)', () => {
            const skills = createBuiltinSkills();
            // 43 entries: 41 canonical skills + 2 deprecated aliases (learner, psm)
    ...
    describe('getBuiltinSkill()', () => {
        ...
        it('should emphasize process-first install routing in the setup skill', () => {
            ...
            expect(skill?.template).toContain('Process request by **first argument only**');
            expect(skill?.template).toContain('/oh-my-caveman:setup doctor --json');
        ...
        it('should retrieve the deep-dive skill with pipeline metadata and 3-point injection', () => {
            ...
            expect(skill?.template).toContain('Skill("oh-my-caveman:autopilot")');
        ...
        it('should expose approval-gated pipeline metadata for deep-interview handoff into omc-plan', () => {
            ...
            expect(skill?.template).not.toContain('3. Invoke Skill("oh-my-caveman:plan")');
            expect(skill?.template).toContain('Only after the user selects this option, invoke `Skill("oh-my-caveman:plan")`');
            ...
            expect(skill?.template).toContain('Skill("oh-my-caveman:autoresearch")');
        });
        ...
        it('rewrites built-in skill command examples to plugin-safe bridge invocations when omc is unavailable', () => {
            ...
            try {
                ...
                expect(deepInterviewSkill?.template)
                    .toContain('Skill("oh-my-caveman:autoresearch")');
        ...
        it('should expose approval-gated omc-plan metadata without an unconditional autopilot handoff', () => {
            ...
            expect(skill?.template).not.toContain('Skill("oh-my-caveman:autopilot")');
            expect(skill?.template).not.toContain('3. Invoke Skill("oh-my-caveman:autopilot")');
        ...
        it('should document allowed omc-teams agent types and native team fallback', () => {
            ...
            expect(skill?.template).toContain('/oh-my-caveman:team');
        });
