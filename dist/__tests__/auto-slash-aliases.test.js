...
- doctor -> /oh-my-caveman:omc-doctor with remaining args
- mcp -> /oh-my-caveman:mcp-setup with remaining args
- otherwise -> /oh-my-caveman:omc-setup with remaining args`);
        ...
        expect(result.replacementText).toContain('doctor -> /oh-my-caveman:omc-doctor with remaining args');
...
Deep interview body`);
        ...
        expect(result.replacementText).toContain('Skill("oh-my-caveman:plan")');
...
Deep interview body`);
        ...
        expect(result.replacementText).toContain('Skill("oh-my-caveman:autoresearch")');
