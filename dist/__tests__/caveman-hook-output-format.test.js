...
describe('caveman-activate.cjs (SessionStart envelope)', () => {
    ...
    it('independent mode (commit) emits short activation line in envelope', () => {
        ...
        expect(out.continue).toBe(true);
        expect(out.hookSpecificOutput?.hookEventName).toBe('SessionStart');
        expect(out.hookSpecificOutput?.additionalContext).toBe('CAVEMAN MODE ACTIVE — level: commit. Behavior defined by /caveman-commit skill.');
    });
...
//# sourceMappingURL=caveman-hook-output-format.test.js.map