...
describe('Keyword Detector', () => {
    ...
    describe('getPrimaryKeyword', () => {
        ...
        it('should not detect ralph in /oh-my-caveman:ralph-init', () => {
            const primary = getPrimaryKeyword('/oh-my-caveman:ralph-init "my project"');
...
describe('Team staged workflow integration', () => {
    ...
    it('compacts OMC-style root AGENTS guidance on session-start without dropping key sections', async () => {
        const agentsContent = `# oh-my-caveman - Intelligent Multi-Agent Orchestration
...
- preserve verification
    ...
    it('keeps session-start under budget when only a tiny omission remainder remains', async () => {
        ...
        writeFileSync(join(testDir, 'AGENTS.md'), `# oh-my-caveman - Intelligent Multi-Agent Orchestration
