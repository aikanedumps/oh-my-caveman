...
const CACHE_PATH = `${CLAUDE_CONFIG_DIR}/plugins/oh-my-caveman/.usage-cache-zai.json`;
const CACHE_DIR = `${CLAUDE_CONFIG_DIR}/plugins/oh-my-caveman`;
...
function setupMocks(fsModule, httpStatus, httpBody) {
    ...
    vi.doMock('../../utils/ssrf-guard.js', () => ({
        ...
        validatedLookup: (_h, _o, cb) => cb(null, '93.184.216.34', 4),
    }));
