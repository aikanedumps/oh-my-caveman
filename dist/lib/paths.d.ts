 ...
 */
export declare const OMC_PLUGIN_MARKETPLACE_SLUG = "oh-my-caveman";
export declare const OMC_PLUGIN_PACKAGE_NAME = "oh-my-caveman";
export declare const OMC_PLUGIN_CACHE_REL = "plugins/cache/oh-my-caveman/oh-my-caveman";
export declare const OMC_PLUGIN_MARKETPLACE_REL = "plugins/marketplaces/oh-my-caveman";
