 ...
 * (they have special handling elsewhere or are now skills with oh-my-caveman: prefix)
 */
export const EXCLUDED_COMMANDS = new Set([
    'ralph',
    'oh-my-caveman:ralplan',
    'oh-my-caveman:ultraqa',
    'oh-my-caveman:skillify',
    'oh-my-caveman:learner',
    'oh-my-caveman:plan',
