...
[시작하기](#빠른-시작) • [문서](https://yeachan-heo.github.io/oh-my-caveman-website) • [CLI 레퍼런스](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference) • [워크플로우](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows) • [마이그레이션 가이드](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **참고: 패키지 이름** — 프로젝트 브랜드명은 **oh-my-caveman** (저장소, 플러그인, 명령어)이지만, npm 패키지는 [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman)로 배포됩니다. npm/bun으로 CLI 도구를 설치할 때는 `npm install -g oh-my-caveman`를 사용하세요.
...
### 실행 모드
다양한 사용 사례를 위한 여러 전략 - 완전 자율 빌드부터 토큰 효율적인 리팩토링까지. [자세히 보기 →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
- **[CLI 레퍼런스](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference)** - 모든 `omc` 명령어, 플래그 및 도구
- **[알림 가이드](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#notifications)** - Discord, Telegram, Slack 및 webhook 설정
- **[추천 워크플로우](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows)** - 일반 작업을 위한 검증된 스킬 체인
- **[릴리스 노트](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#release-notes)** - 각 버전의 새로운 기능
- **[웹사이트](https://yeachan-heo.github.io/oh-my-caveman-website)** - 인터랙티브 가이드와 예제
