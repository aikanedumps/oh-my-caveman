...
You are running with oh-my-caveman (OMC), a multi-agent orchestration layer for Claude Code.
...
<agent_catalog>
Prefix: `oh-my-caveman:`. See `agents/*.md` for full prompts.
...
<skills>
Invoke via `/oh-my-caveman:<name>`. Trigger patterns auto-detect keywords.
...
Say "setup omc" or run `/oh-my-caveman:omc-setup`.
