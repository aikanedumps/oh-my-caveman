...
[Başlangıç](#hızlı-başlangıç) • [Dokümantasyon](https://yeachan-heo.github.io/oh-my-caveman-website) • [Geçiş Rehberi](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Not: Paket adlandırması** — Proje **oh-my-caveman** markasını kullanır (repo, plugin, komutlar), ancak npm paketi [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman) olarak yayınlanmaktadır. CLI araçlarını npm/bun ile kuruyorsanız, `npm install -g oh-my-caveman` kullanın.
...
Farklı kullanım senaryoları için birden fazla strateji — Team destekli orkestrasyondan token-verimli yeniden düzenlemeye. [Daha fazla bilgi →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
| -------------- | ---------------------------------------- | --------------------------------------------------------------- |
| `team`         | Kanonik Team orkestrasyonu               | `/oh-my-caveman:team 3:executor "fix all TypeScript errors"` |
...
- **[Web Sitesi](https://yeachan-heo.github.io/oh-my-caveman-website)** — İnteraktif rehberler ve örnekler
