...
**User skill:** `/oh-my-caveman:note`
- `/oh-my-caveman:note <content>` - Add to Working Memory
- `/oh-my-caveman:note --priority <content>` - Add to Priority Context
- `/oh-my-caveman:note --manual <content>` - Add to MANUAL section
- `/oh-my-caveman:note --show` - Display notepad contents
