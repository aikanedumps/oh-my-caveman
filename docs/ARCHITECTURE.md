...
> How oh-my-caveman orchestrates multi-agent workflows.

## Overview

oh-my-caveman enables Claude Code to orchestrate specialized agents through a skill-based routing system. It is built on four interlocking systems: **Hooks** detect lifecycle events, **Skills** inject behaviors, **Agents** execute specialized work, and **State** tracks progress across context resets.
...
OMC provides 19 specialized agents organized into 4 lanes. Each agent is invoked as `oh-my-caveman:<agent-name>` and runs on the appropriate model tier.
...
**Slash commands:**
```bash
/oh-my-caveman:autopilot build me a todo app
/oh-my-caveman:ralph refactor the auth module
/oh-my-caveman:team 3:executor "implement fullstack app"
```
...
```bash
/oh-my-caveman:team 3:executor "implement fullstack todo app"
```
...
|-------|-------------|---------|
| `cancel` | Cancel active execution mode | `/oh-my-caveman:cancel` |
| `hud` | Status bar configuration | `/oh-my-caveman:hud` |
| `omc-setup` | Initial setup wizard | `/oh-my-caveman:omc-setup` |
| `omc-doctor` | Diagnose installation | `/oh-my-caveman:omc-doctor` |
| `skillify` | Extract reusable skills from session | `/oh-my-caveman:skillify` (`learner` deprecated alias) |
| `skill` | Manage local skills (list/add/remove) | `/oh-my-caveman:skill` |
| `trace` | Evidence-driven causal tracing | `/oh-my-caveman:trace` |
| `release` | Automated release workflow | `/oh-my-caveman:release` |
| `deepinit` | Generate hierarchical AGENTS.md | `/oh-my-caveman:deepinit` |
| `deep-interview` | Socratic deep interview | `/oh-my-caveman:deep-interview` |
| `sciomc` | Parallel scientist agent orchestration | `/oh-my-caveman:sciomc` |
| `external-context` | Parallel document-specialist research | `/oh-my-caveman:external-context` |
| `ai-slop-cleaner` | Clean AI expression patterns | `/oh-my-caveman:ai-slop-cleaner` |
| `writer-memory` | Memory system for writing projects | `/oh-my-caveman:writer-memory` |
