...
Hooks are scripts that execute automatically in response to Claude Code lifecycle events. oh-my-caveman extends Claude Code's default behavior with 20 hooks.
...
- **Cancel**: Use `/oh-my-caveman:cancel` to deactivate modes
...
```
/oh-my-caveman:team 3:executor "build a fullstack todo app"
```
