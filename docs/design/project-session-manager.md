...
```bash
# Review PR #123 from oh-my-caveman repo
/psm review omc#123
...
// .psm-session.json
{
  ...
  "source_repo": "~/Workspace/oh-my-caveman",
  "github": {
    "pr_number": 123,
    "pr_title": "Add webhook support",
    "pr_author": "contributor",
    "pr_url": "https://github.com/anthropics/oh-my-caveman/pull/123"
  },
  "state": "active",
  "notes": []
}
...
🔍 Fetching PR #123 from oh-my-caveman...
