...
User documentation and technical guides for oh-my-caveman.

## Purpose

This directory contains documentation for end-users and developers:

- **End-user guides**: How to use oh-my-caveman features
...
[Migration Guide](https://raw.githubusercontent.com/aikanedumps/oh-my-caveman/main/docs/MIGRATION.md)
