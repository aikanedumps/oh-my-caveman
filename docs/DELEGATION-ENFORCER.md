...
```typescript
import { enforceModel } from 'oh-my-caveman';
...
```typescript
import { getModelForAgent } from 'oh-my-caveman';
...
```typescript
import { isAgentCall } from 'oh-my-caveman';
...
```typescript
import { processHook } from 'oh-my-caveman';
