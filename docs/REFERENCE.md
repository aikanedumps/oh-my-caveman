...
| `learner`                 | Extract reusable skill from session                              | `/oh-my-caveman:learner`                 |
...
| `omc-plan`                | Planning workflow (`/plan` safe alias)                           | `/oh-my-caveman:omc-plan`                |
...
| `ralplan`                 | Consensus planning alias for `/omc-plan --consensus`             | `/oh-my-caveman:ralplan`                 |
...
| `/oh-my-caveman:omc-plan <description>`      | Start planning session (supports consensus structured deliberation)                        |
