...
Comprehensive guide to monitoring, debugging, and optimizing Claude Code and oh-my-caveman performance.
...
oh-my-caveman provides comprehensive monitoring capabilities for tracking agent performance, token usage, costs, and identifying bottlenecks in multi-agent workflows. This guide covers both built-in tools and external resources for monitoring Claude's performance.
...
```typescript
import { getAgentObservatory } from 'oh-my-caveman/hooks/subagent-tracker';
...
```typescript
import { getReplaySummary } from 'oh-my-caveman/hooks/subagent-tracker/session-replay';
...
```typescript
import { getAgentPerformance } from 'oh-my-caveman/hooks/subagent-tracker';
...
```typescript
import { detectFileConflicts } from 'oh-my-caveman/hooks/subagent-tracker';
...
```typescript
import { suggestInterventions } from 'oh-my-caveman/hooks/subagent-tracker';
...
```typescript
import { calculateParallelEfficiency } from 'oh-my-caveman/hooks/subagent-tracker';
...
```typescript
import { cleanupStaleAgents } from 'oh-my-caveman/hooks/subagent-tracker';
...
| OMC GitHub Issues | Bug reports and feature requests | [GitHub Issues](https://github.com/aikanedumps/oh-my-caveman/issues) |
...
```typescript
import { cleanupReplayFiles } from 'oh-my-caveman/hooks/subagent-tracker/session-replay';
...
2. Verify HUD / hooks are installed: `/oh-my-caveman:hud setup`
