...
How to install oh-my-caveman from a local development directory as a Claude Code plugin.
...
- **npm users**: prefer `npm i -g oh-my-caveman@latest`
...
# Uninstall
claude plugin uninstall oh-my-caveman@oh-my-caveman

# Remove marketplace
claude plugin marketplace remove oh-my-caveman
```
...
- Run `omc doctor --plugin-dir /path/to/oh-my-caveman` to diagnose issues
