...
[Loslegen](#schnellstart) • [Dokumentation](https://yeachan-heo.github.io/oh-my-caveman-website) • [Migrationsleitfaden](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
```bash
/oh-my-caveman:team 3:executor "fix all TypeScript errors"
```
...
> **Hinweis: Paketbenennung** — Das Projekt nutzt die Marke **oh-my-caveman** (Repo, Plugin, Befehle), aber das npm-Paket wird als [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman) veröffentlicht. Wenn Sie die CLI-Tools über npm/bun installieren, verwenden Sie `npm install -g oh-my-caveman`.
...
Mehrere Strategien für verschiedene Anwendungsfälle — von Team-gestützter Orchestrierung bis token-effizientem Refactoring. [Mehr erfahren →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
| ------------- | ------------------------------------------------ | --------------------------------------------------------------- |
| `team`        | Kanonische Team-Orchestrierung                   | `/oh-my-caveman:team 3:executor "fix all TypeScript errors"` |
...
- **[Website](https://yeachan-heo.github.io/oh-my-caveman-website)** — Interaktive Anleitungen und Beispiele
