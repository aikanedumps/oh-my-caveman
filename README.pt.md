...
[Começar Rápido](#início-rápido) • [Documentação](https://yeachan-heo.github.io/oh-my-caveman-website) • [Referência CLI](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference) • [Workflows](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows) • [Guia de Migração](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Observação: Nome do pacote** — O projeto usa a marca **oh-my-caveman** (repo, plugin, comandos), mas o pacote npm é publicado como [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman). Se você instalar as ferramentas de CLI via npm/bun, use `npm install -g oh-my-caveman`.
...
Múltiplas estratégias para diferentes casos de uso — da orquestração com Team até refatoração com eficiência de tokens. [Saiba mais →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
- **[Referência CLI](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference)** - Todos os comandos, flags e ferramentas do `omc`
- **[Guia de Notificações](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#notifications)** - Configuração de Discord, Telegram, Slack e webhooks
- **[Workflows Recomendados](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows)** - Cadeias de skills testadas em batalha para tarefas comuns
- **[Notas de Lançamento](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#release-notes)** - Novidades em cada versão
- **[Website](https://yeachan-heo.github.io/oh-my-caveman-website)** - Guias interativos e exemplos
