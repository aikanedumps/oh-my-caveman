...
[Démarrer](#démarrage-rapide) • [Documentation](https://yeachan-heo.github.io/oh-my-caveman-website) • [Guide de migration](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Note : Nom du package** — Le projet utilise la marque **oh-my-caveman** (repo, plugin, commandes), mais le package npm est publié sous le nom [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman). Si vous installez les outils CLI via npm/bun, utilisez `npm install -g oh-my-caveman`.
...
Plusieurs stratégies pour différents cas d'utilisation — de l'orchestration Team au refactoring économe en tokens. [En savoir plus →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
| ------------ | ----------------------------------- | --------------------------------------------------------------- |
| `team`       | Orchestration Team canonique        | `/oh-my-caveman:team 3:executor "fix all TypeScript errors"` |
...
- **[Site web](https://yeachan-heo.github.io/oh-my-caveman-website)** — Guides interactifs et exemples
