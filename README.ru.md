...
[Начать](#быстрый-старт) • [Документация](https://yeachan-heo.github.io/oh-my-caveman-website) • [Руководство по миграции](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Примечание: Название пакета** — Проект использует бренд **oh-my-caveman** (репозиторий, плагин, команды), но npm-пакет публикуется как [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman). Если вы устанавливаете CLI-инструменты через npm/bun, используйте `npm install -g oh-my-caveman`.
...
Множество стратегий для разных сценариев — от оркестрации через Team до рефакторинга с экономией токенов. [Подробнее →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
| -------------- | ----------------------------------------------- | --------------------------------------------------------------- |
| `team`         | Каноническая Team-оркестрация                   | `/oh-my-caveman:team 3:executor "fix all TypeScript errors"` |
...
- **[Веб-сайт](https://yeachan-heo.github.io/oh-my-caveman-website)** — Интерактивные руководства и примеры
