...
[![npm version](https://img.shields.io/npm/v/oh-my-caveman?color=cb3837)](https://www.npmjs.com/package/oh-my-caveman)
[![npm downloads](https://img.shields.io/npm/dm/oh-my-caveman?color=blue)](https://www.npmjs.com/package/oh-my-caveman)
[![GitHub stars](https://img.shields.io/github/stars/aikanedumps/oh-my-caveman?style=flat&color=yellow)](https://github.com/aikanedumps/oh-my-caveman/stargazers)
...
[Comenzar](#inicio-rápido) • [Documentación](https://yeachan-heo.github.io/oh-my-caveman-website) • [Referencia CLI](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference) • [Flujos de Trabajo](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows) • [Guía de Migración](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Nota: Nombre del paquete** — El proyecto usa la marca **oh-my-caveman** (repositorio, plugin, comandos), pero el paquete npm se publica como [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman). Si instalas las herramientas CLI via npm/bun, usa `npm install -g oh-my-caveman`.
...
<p align="center">
  <img src="assets/omc-character.jpg" alt="oh-my-caveman" width="400" />
</p>

---

## ¿Por qué oh-my-caveman?
...
### Modos de Ejecución
Múltiples estrategias para diferentes casos de uso - desde construcciones completamente autónomas hasta refactorización eficiente en tokens. [Aprende más →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
```bash
/oh-my-caveman:configure-notifications
...
- **[Referencia CLI](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference)** - Todos los comandos, flags y herramientas de `omc`
- **[Guía de Notificaciones](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#notifications)** - Configuración de Discord, Telegram, Slack y webhooks
- **[Flujos de Trabajo Recomendados](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows)** - Cadenas de habilidades probadas para tareas comunes
- **[Notas de Versión](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#release-notes)** - Novedades en cada versión
- **[Sitio Web](https://yeachan-heo.github.io/oh-my-caveman-website)** - Guías interactivas y ejemplos
...
[![Star History Chart](https://api.star-history.com/svg?repos=aikanedumps/oh-my-caveman&type=date&legend=top-left)](https://www.star-history.com/#aikanedumps/oh-my-caveman&type=date&legend=top-left)
