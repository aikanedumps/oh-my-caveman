...
[はじめる](#クイックスタート) • [ドキュメント](https://yeachan-heo.github.io/oh-my-caveman-website) • [CLI リファレンス](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference) • [ワークフロー](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows) • [移行ガイド](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **注意: パッケージ名について** — プロジェクトのブランド名は **oh-my-caveman**（リポジトリ、プラグイン、コマンド）ですが、npmパッケージは [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman) として公開されています。npm/bunでCLIツールをインストールする場合は `npm install -g oh-my-caveman` を使用してください。
...
### 実行モード
用途に応じた複数の戦略 - 完全自律ビルドからトークン効率の良いリファクタリングまで。[詳しくはこちら →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
- **[CLI リファレンス](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#cli-reference)** - すべての `omc` コマンド、フラグ、ツール
- **[通知ガイド](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#notifications)** - Discord、Telegram、Slack、webhook のセットアップ
- **[推奨ワークフロー](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#workflows)** - 一般的なタスクのための実績あるスキルチェーン
- **[リリースノート](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#release-notes)** - 各バージョンの新機能
- **[ウェブサイト](https://yeachan-heo.github.io/oh-my-caveman-website)** - インタラクティブガイドと例
