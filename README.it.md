...
[Inizia](#avvio-rapido) • [Documentazione](https://yeachan-heo.github.io/oh-my-caveman-website) • [Guida alla migrazione](docs/MIGRATION.md) • [Discord](https://discord.gg/PUwSMR9XNk)
...
> **Nota: Nome del pacchetto** — Il progetto utilizza il brand **oh-my-caveman** (repo, plugin, comandi), ma il pacchetto npm è pubblicato come [`oh-my-caveman`](https://www.npmjs.com/package/oh-my-caveman). Se installi gli strumenti CLI tramite npm/bun, usa `npm install -g oh-my-caveman`.
...
Strategie multiple per diversi casi d'uso — dall'orchestrazione basata su Team al refactoring efficiente in termini di token. [Scopri di più →](https://yeachan-heo.github.io/oh-my-caveman-website/docs/#execution-modes)
...
| ------------- | ----------------------------------------- | --------------------------------------------------------------- |
| `team`        | Orchestrazione Team canonica              | `/oh-my-caveman:team 3:executor "fix all TypeScript errors"` |
...
- **[Sito web](https://yeachan-heo.github.io/oh-my-caveman-website)** — Guide interattive ed esempi
