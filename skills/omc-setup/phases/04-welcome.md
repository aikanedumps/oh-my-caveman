...
- /oh-my-caveman:team 5:debugger "fix build errors in src/"
Teams use Claude Code native tools (TeamCreate/SendMessage/TaskCreate).

MCP SERVERS:
Run /oh-my-caveman:mcp-setup to add tools like web search, GitHub, etc.
...
```bash
gh api user/starred/aikanedumps/oh-my-caveman &>/dev/null
```
...
**Question:** "If you're enjoying oh-my-caveman, would you like to support the project by starring it on GitHub?"
...
```bash
gh api -X PUT /user/starred/aikanedumps/oh-my-caveman 2>/dev/null && echo "Thanks for starring!" || true
```
...
```bash
echo ""
echo "If you enjoy oh-my-caveman, consider starring the repo:"
echo "  https://github.com/aikanedumps/oh-my-caveman"
echo ""
```
