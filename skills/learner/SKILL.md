...
> Deprecated compatibility alias: use `/oh-my-caveman:skillify` for new skill extraction workflows. This file remains for internal implementation/history and compatibility.
...
- /oh-my-caveman:ralph - Start a development loop with learning capture
