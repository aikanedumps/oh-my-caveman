...
Creates comprehensive, hierarchical AGENTS.md documentation across entire codebase.

## Core Concept

AGENTS.md files are **AI-readable documentation** that help agents understand:
...
Every AGENTS.md (except root) includes parent reference tag:
...
## Key Files
{List each significant file with one-line description}
...
### Internal
{References to other parts of codebase this depends on}
...
## Purpose
Web application for managing user tasks with real-time collaboration features.
...
### Working In This Directory
- Always install dependencies after modifying project manifest
...
When running on existing codebase with AGENTS.md files:
