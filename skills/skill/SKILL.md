...
**Built-in skill note:** Built-in skills are bundled with oh-my-caveman and are discoverable/readable, but not removed or edited through `/skill remove` or `/skill edit`.
...
- `/oh-my-caveman:skill add` - Start skill creation (invoke skillify)
...
- `/oh-my-caveman:skillify` - Extract a skill from current conversation (`/oh-my-caveman:learner` is a deprecated alias)
...
- Run `/oh-my-caveman:skill list` periodically to review your skill library
