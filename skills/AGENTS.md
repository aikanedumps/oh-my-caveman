...
Skills are reusable workflow templates that can be invoked via `/oh-my-caveman:skill-name`. Each skill provides:
...
```bash
# Manual invocation
/oh-my-caveman:skill-name

# With arguments
/oh-my-caveman:skill-name arg1 arg2
...
- Test skill invocation with `/oh-my-caveman:skill-name`
