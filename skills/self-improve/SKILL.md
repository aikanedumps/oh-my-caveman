...
**6a. Architecture Review**: Spawn `oh-my-caveman:architect` with the plan + 6-point checklist:
...
**6b. Critic Review**: Spawn `oh-my-caveman:critic` with the plan + harness rules:
