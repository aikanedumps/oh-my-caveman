...
- Cancel with `/oh-my-caveman:cancel` at any time; progress is preserved for resume
</Execution_Policy>
...
If autopilot was cancelled or failed, run `/oh-my-caveman:autopilot` again to resume from where it stopped.
