...
This compatibility command keeps `/oh-my-caveman:visual-verdict` available without loading the full `visual-verdict` skill description in every Claude Code session.
