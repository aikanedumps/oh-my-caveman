...
This compatibility command keeps `/oh-my-caveman:omc-doctor` available without loading the full `omc-doctor` skill description in every Claude Code session.
