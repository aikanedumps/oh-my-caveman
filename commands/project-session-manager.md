...
This compatibility command keeps `/oh-my-caveman:project-session-manager` available without loading the full `project-session-manager` skill description in every Claude Code session.
