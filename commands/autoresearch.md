...
This compatibility command keeps `/oh-my-caveman:autoresearch` available without loading the full `autoresearch` skill description in every Claude Code session.
