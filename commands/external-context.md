...
This compatibility command keeps `/oh-my-caveman:external-context` available without loading the full `external-context` skill description in every Claude Code session.
