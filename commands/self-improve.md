...
This compatibility command keeps `/oh-my-caveman:self-improve` available without loading the full `self-improve` skill description in every Claude Code session.
